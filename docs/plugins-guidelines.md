...
Storefronts that are not services. A plugin that acts only as a front-end for products to be purchased from external systems will not be accepted. 7. Plugins may not track users without their consent.
...
Intentionally attempting to exploit loopholes in the guidelines 10. Plugins may not embed external links or credits on the public site without explicitly asking the user’s permission.
